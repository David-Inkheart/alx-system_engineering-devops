<h1>Tasks on Web stack debugging #4</h1>

<h2>0. Sky is the limit, let's bring that limit higher</h2>

<p>In this web stack debugging task, we are testing how well our web server setup
featuring Nginx is doing under pressure and it turns out it is not doing well:
...
<p>Change the OS configuration so that it is possible to login with the
holberton user and open a file without any error message</p>
